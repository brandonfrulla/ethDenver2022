...
contract SimpleBank{
    ...
    // it should take 3 arguments: an accountAddress, withdrawAmount and a newBalance 
    ...
    function getBalance() public view returns (uint) {
      ...
      //  KEYWORD prevents function from editing state variables;
    ...
    function deposit() public payable returns (uint) {
      ...
      // 3. Add the amount to the user's balance. the amount can be
    ...
    function withdraw(uint withdrawAmount) public payable returns (uint) {
     ...
     /// !! Error on the transfer line below
